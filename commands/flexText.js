...
export default async (event) => {
  try {
    ...
    for (let i = 0; i < 12; i++) {
      const b = template()
      b.header.contents[1].contents[0].text = event.message.text
      b.header.contents[1].contents[2].text = location[0][0].time[i].startTime.split(' ')[0]
      ...
      if (location[0][0].time[i].startTime.split(' ')[1] === '06:00:00' ||
        ...
        b.header.contents[1].contents[3].text = `(白天)${location[0][0].time[i].startTime.split(' ')[1].slice(0, 5)}~${location[0][0].time[i].endTime.split(' ')[1].slice(0, 5)}`
        // 白天的圖片
        ...
        b.header.contents[1].contents[2].color = '#000000'
        b.header.contents[1].contents[3].color = '#000000'
      } else {
        ...
        b.header.contents[1].contents[3].text = `(晚上)${location[0][0].time[i].startTime.split(' ')[1].slice(0, 5)}~${location[0][0].time[i].endTime.split(' ')[1].slice(0, 5)}`
        // 晚上的圖片
        b.body.contents[0].contents[1].url =
